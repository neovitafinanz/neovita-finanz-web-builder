...
const RachatCredit = () => {
  ...
  const advantages = [
    t('creditBuyback.advantages.reducedPayments'),
    t('creditBuyback.advantages.simplifiedManagement'),
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="mt-8">
                ...
                >
                  {t('creditBuyback.advantages.cta')}
                </Button>
              </div>
            </div>
            <div>
              <img
                ...
                alt={t('creditBuyback.advantages.imgAlt')}
