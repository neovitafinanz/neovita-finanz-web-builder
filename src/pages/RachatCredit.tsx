...
const RachatCredit = () => {
  ...
  const advantages = [
    t('creditBuyback.advantages.reducePayments'),
    t('creditBuyback.advantages.simplifyManagement'),
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              {t('creditBuyback.title')}
            </h1>
            <p className="text-xl lg:text-2xl mb-8 text-gray-200">
              {t('creditBuyback.subtitle')}
            </p>
            <Button 
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="mt-8">
                ...
                >
                  {t('creditBuyback.advantages.studyFile')}
                </Button>
              </div>
            </div>
            <div>
