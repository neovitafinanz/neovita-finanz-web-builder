...
const Assurances = () => {
  ...
  const insuranceTypes = [
    {
      title: t('insurance.types.borrowerInsurance.title'),
      description: t('insurance.types.borrowerInsurance.description'),
      icon: Shield
    },
    {
      title: t('insurance.types.homeInsurance.title'),
      description: t('insurance.types.homeInsurance.description'),
      icon: Home
    },
    {
      title: t('insurance.types.healthInsurance.title'),
      description: t('insurance.types.healthInsurance.description'),
      icon: Heart
    }
  ];
